        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/auth/sessao")
                    .hasAnyRole("VIEWER", "OPERATOR", "GESTOR", "ADMIN", "FORNECEDOR")
                ...
                .requestMatchers(HttpMethod.DELETE, "/movimentos/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/fornecedores/**", "/promotores/**", "/movimentos/**", "/dashboard/**")
                    .hasAnyRole("VIEWER", "OPERATOR", "GESTOR", "ADMIN", "FORNECEDOR")
                .requestMatchers(HttpMethod.GET, "/empresas-cadastro/**")
                    .hasAnyRole("VIEWER", "OPERATOR", "GESTOR", "ADMIN", "FORNECEDOR")
                .requestMatchers(HttpMethod.GET, "/empresas/*/configuracao")
                    .hasAnyRole("VIEWER", "OPERATOR", "GESTOR", "ADMIN", "FORNECEDOR")
                .requestMatchers(HttpMethod.POST, "/fornecedores/**", "/promotores/**")
                    .hasAnyRole("OPERATOR", "GESTOR", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/empresas-cadastro/**")
                    .hasAnyRole("OPERATOR", "GESTOR", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/empresas/*/configuracao")
                    .hasAnyRole("OPERATOR", "GESTOR", "ADMIN")
                ...
                .requestMatchers(HttpMethod.PUT, "/promotores/**")
                    .hasAnyRole("OPERATOR", "GESTOR", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/empresas-cadastro/**")
                    .hasAnyRole("OPERATOR", "GESTOR", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/empresas/*/configuracao")
                    .hasAnyRole("OPERATOR", "GESTOR", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/empresas/*/configuracao")
                    .hasAnyRole("OPERATOR", "GESTOR", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/empresas-cadastro/**")
                    .hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/fornecedores/**", "/promotores/**")
                    .hasRole("ADMIN")
                .anyRequest().denyAll()
            )
