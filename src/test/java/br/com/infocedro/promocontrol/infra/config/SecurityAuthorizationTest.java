...
class SecurityAuthorizationTest {
    ...
    void setup() {
        ...
        if (!usuarioRepository.existsByUsernameIgnoreCase("gestor")) {
            authUserService.createUserByAdmin("gestor", "GESTOR", "ATIVO", true, false, null);
    ...
    void adminDeveExcluirUsuario() throws Exception {
        authUserService.createUserByAdmin("temp.delete.user", "VIEWER", "ATIVO", true, false, null);
    ...
    void gestorNaoDeveExcluirUsuario() throws Exception {
        authUserService.createUserByAdmin("temp.delete.user.2", "VIEWER", "ATIVO", true, false, null);
